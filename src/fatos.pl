personagem(harry_potter, grifinoria, cervo, sangue_puro).
personagem(hermione_granger, grifinoria, lontra, mestiço).
personagem(rony_weasley, grifinoria, desconhecido, sangue_puro).
personagem(draco_malfoy, sonserina, desconhecido, sangue_puro).
personagem(luna_lovegood, corvinal, desconhecido, sangue_puro).
personagem(cedrico_diggory, lufalufa, desconhecido, sangue_puro).

patrono(harry_potter, cervo).
patrono(hermione_granger, lontra).
patrono(rony_weasley, desconhecido).
